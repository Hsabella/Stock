...
.venv-quant/bin/python -m quant.research.stock_lights --status  # 个股抄底灯当前灯态
                                                      # (回测定案 docs/quant/stock_lights_report.md:
                                                      #  左侧L6/L1有效+中证1000红灯期超额最大,
                                                      #  右侧确认/L4底背离已证伪; 不带--status为重跑回测)
